...
SELECT '123e4567-e89b-12d3-a456-426614174003',
       ...
       '1982-11-30',
       '2023-05-14'
    WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = '123e4567-e89b-12d3-a456-426614174003');
...
SELECT '123e4567-e89b-12d3-a456-426614174004',
       ...
       '1995-02-05',
       '2024-03-01'
    WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = '123e4567-e89b-12d3-a456-426614174004');

-- More user insertions
INSERT INTO users (id, name, email, address, date_of_birth, registered_date)
